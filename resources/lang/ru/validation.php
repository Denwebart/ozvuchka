...
return [
    ...
    */
    ...
    'max'                  => [
	    ...
	    "file"    => "Размер файла не должен быть больше чем :max Килобайт(а).",
    ...
    'min'                  => [
        ...
        'file'    => 'Размер файла не должен быть меньше чем :min Килобайт(а).',
    ...
    */
    ...
    'custom'               => [
	    ...
	    'password_confirmation' => [
		    'required_with' => 'Повторите пароль.',
		    'same' => 'Пароли не совпадают, повторите попытку.',
	    ],
	    'is_agree' => [
