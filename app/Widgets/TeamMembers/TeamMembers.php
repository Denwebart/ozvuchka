...
class TeamMembers
{
	...
	public function show()
	{
		return \Cache::rememberForever('widgets.teamMembers', function() {
			...
			$items = TeamMember::select(['id', 'name', 'description', 'image', 'image_alt', 'position', 'is_published',' link_website', 'link_vk', 'link_facebook', 'link_instagram', 'link_twitter', 'link_google', 'link_youtube'])
				->published()
