            ...
            <div class="row item team-members-item" id="{{ $item->id }}" data-item-id="{{ $item->id }}">
                <div class="thumbnail p-0 m-b-0">
                    <div class="col-sm-4 p-t-b-10">
                        {!! Form::file('image', ['id' => 'image-' . $item->id, 'class' => 'dropify-ajax', 'data-default-file' => $item->getImageUrl(), 'data-height' => '120px', 'data-max-file-size' => '3M', 'data-min-width' => '339', 'data-min-height' => '459', 'data-item-id' => $item->id, 'data-delete-url' => route('admin.teamMembers.deleteImage'), 'data-upload-url' => route('admin.teamMembers.uploadImage')]) !!}
                    </div>
                    <div class="col-sm-6 p-t-b-10">
                        ...
                        <div class="social-links social-links-{{ $item->id }}">
                            ...
                            <div class="social-links-form-{{ $item->id }}" style="display: none">
                                ...
                                <p>
                                    ...
                                    <a href="#" class="editable-text" data-value="{{ $item->link_facebook }}" data-name="link_facebook" data-type="text" data-pk="{{ $item->id }}" data-url="{{ route('admin.teamMembers.setValue') }}">{{ $item->link_facebook }}</a>
                                </p>
                                <p>
                                    <b class="font-13 text-muted" style="width: 75px; display: inline-block">Instagram:</b>
                                    <a href="#" class="editable-text" data-value="{{ $item->link_instagram }}" data-name="link_instagram" data-type="text" data-pk="{{ $item->id }}" data-url="{{ route('admin.teamMembers.setValue') }}">{{ $item->link_instagram }}</a>
                                </p>
                                <p>
                                    <b class="font-13 text-muted" style="width: 75px; display: inline-block">Twitter:</b>
                                    <a href="#" class="editable-text" data-value="{{ $item->link_twitter }}" data-name="link_twitter" data-type="text" data-pk="{{ $item->id }}" data-url="{{ route('admin.teamMembers.setValue') }}">{{ $item->link_twitter }}</a>
                                </p>
                                <p>
                                    <b class="font-13 text-muted" style="width: 75px; display: inline-block">Google:</b>
                                    <a href="#" class="editable-text" data-value="{{ $item->link_google }}" data-name="link_google" data-type="text" data-pk="{{ $item->id }}" data-url="{{ route('admin.teamMembers.setValue') }}">{{ $item->link_google }}</a>
                                </p>
                                <p>
                                    <b class="font-13 text-muted" style="width: 75px; display: inline-block">YouTube:</b>
                                    <a href="#" class="editable-text" data-value="{{ $item->link_youtube }}" data-name="link_youtube" data-type="text" data-pk="{{ $item->id }}" data-url="{{ route('admin.teamMembers.setValue') }}">{{ $item->link_youtube }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
