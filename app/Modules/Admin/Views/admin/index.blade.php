            ...
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table class="table table-hover m-0 mails table-actions-bar">
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backend/images/users/avatar-3.jpg') }}" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backend/images/users/avatar-4.jpg') }}" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backend/images/users/avatar-5.jpg') }}" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backend/images/users/avatar-8.jpg') }}" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                            </td>
